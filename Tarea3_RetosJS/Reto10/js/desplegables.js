//todo esto son animaciones que puedo añadir en el id="r0" del html de escala
//los desplegables ya vienen configurados como si fuera una libreria
$("#r0").click(function() {
    Swal.fire({
        icon: 'error',
...
$("#r1").click(function() {
    Swal.fire({
        ...
        animation: true,
        showClass: {
            popup: 'animated bounceIn', //esto viene del css animate.css de la libreria 
        },
        hideClass: {
